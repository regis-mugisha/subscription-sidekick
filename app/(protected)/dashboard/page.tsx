...
export default function Dashboard() {
  ...
  const [viewing, setViewing] = useState<(typeof subscriptions)[number] | null>(
    null
  );
  const [editing, setEditing] = useState<(typeof subscriptions)[number] | null>(
    null
  );
          ...
          {viewing ? (
            <div className="grid gap-2 text-sm">
              ...
              <div>
                ...
                {viewing?.renewalDate
                  ? new Date(viewing?.renewalDate).toLocaleDateString()
                  : "-"}
              </div>
            </div>
          ) : null}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setEditForm({ ...editForm, billingCycle: v })
                }
              >
                <SelectTrigger>
